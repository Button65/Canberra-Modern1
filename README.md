...
- Form submission shows alert (you can connect to a backend)
- Images use crisp-edges rendering and filters for clarity
- Shadows and gradients match the React version
